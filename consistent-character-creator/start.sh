...
#    fi    
    ...
    MODELS=(
        "$MODELS_BASE/diffusion_models/Qwen-Image-Edit-2509_fp8_e4m3fn.safetensors|https://huggingface.co/aidiffuser/Qwen-Image-Edit-2509/resolve/main/Qwen-Image-Edit-2509_fp8_e4m3fn.safetensors"
