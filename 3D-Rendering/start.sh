...
if [ -d "$OLD_VENV_DIR" ] && [ ! -d "$VENV_DIR" ]; then
    ...
    BAKED_NODES="ComfyUI-Manager ComfyUI-KJNodes Civicomfy ComfyUI-RunpodDirect ComfyUI-LTXVideo ComfyUI-Mickmumpitz-Nodes ComfyUI-VideoHelperSuite comfyui_controlnet_aux ComfyUI_essentials ComfyUI-Inpaint-CropAndStitch ComfyUI-Easy-Use rgthree-comfy"
    CURRENT=0
    INSTALLED=0
